...
// Get user name or prompt if not set
let myName = prompt("Enter your name for the map:") || "Explorer";
let myAvatar = 'friend1.png'; // Default avatar

// Initialize Leaflet Map centered around Koraput / Rourkela region
...
if ("geolocation" in navigator) {
    navigator.geolocation.watchPosition((position) => {
        ...
        const weatherText = "28°C"; // Default or live weather placeholder
...
if (mapFileInput) {
    mapFileInput.addEventListener('change', (e) => {
        ...
        reader.onload = (event) => {
            ...
            // Listen for a single click on the map to drop the pin precisely where desired
